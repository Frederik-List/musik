...
> Åbn denne side på [https://frederik-list.github.io/musik/](https://frederik-list.github.io/musik/)
...
* søg efter **https://github.com/frederik-list/musik**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/frederik-list/musik/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/frederik-list/musik**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/frederik-list/musik/raw/master/.github/makecode/blocks.png)
